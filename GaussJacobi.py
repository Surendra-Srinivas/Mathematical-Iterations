# The error “typeerror: can’t multiply sequence by non-int of type ‘float’” is caused by multiplying a string 
# and a floating-point number together.
# x_1 = (1/a11)*[b1 - a12*x2 - a13*x3]
# print(type([b1 - a12*x2 - a13*x3]))
...
for i in range(15):
    x_1 = (1/a11)*(b1 - a12*x2 - a13*x3)
    x_2 = (1/a22)*(b2 - a21*x1 - a23*x3)
    x_3 = (1/a33)*(b3 - a31*x1 - a32*x2)
